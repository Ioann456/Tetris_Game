...
void GameField::render(PaintDevice& paintDevice)
{
	...
	for (int i = 1; i < 5; i++)
	{
		Vector2 v2(m_Width, i);
		paintDevice.set_char(v2, 0x2551);
	}
	for (int i = 1; i < 5; i++)
	{
		Vector2 v2(m_Width + 6, i);
		paintDevice.set_char(v2, 0x2551);
	}


	Vector2 v15(14, 0);
	paintDevice.set_char(v15, 0x2554);
	Vector2 v16(20, 0);
	paintDevice.set_char(v16, 0x2557);
	Vector2 v17(14, 5);
	paintDevice.set_char(v17, 0x255A);
	Vector2 v18(20, 5);
	paintDevice.set_char(v18, 0x255D);
